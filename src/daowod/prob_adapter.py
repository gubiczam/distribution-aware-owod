...
class ProbAdapter:
    ...
    def _run(self, template: str, **values: object) -> None:
    ...
    def train(
        ...
        *,
        ...
        self._write_ids(labelled_path, labelled_image_ids)
        self._run(
            self.train_command,
    ...
    def predict(
        ...
        *,
        ...
        self._write_ids(ids_path, image_ids)
        self._run(
    ...
    def evaluate(
        ...
        *,
        ...
        required = {"known_mAP", "U_Recall", "WI", "A_OSE"}
