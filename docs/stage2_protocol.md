...
- Class-group mapping: version-controlled protocol asset, `data/protocol/stage2/stage2_class_groups.csv`. It is a protocol input, not a run artifact, so a clean clone can resolve it.
